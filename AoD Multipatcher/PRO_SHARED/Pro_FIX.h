...
enum class PS_FILTER {NONE, SEPIA, EMBOSS, SHARPENING, DISTORT, NEGATIVE, GRAYSCALE, BW, BWINVERSE, RED, GREEN, BLUE, NIGHTVISION, POSTERIZE, MOSAIC, DRAWING, NEON, ANAGLYPH, VIGNETTE, DOF};
